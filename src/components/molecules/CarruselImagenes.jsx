    ...
    <>
      ...
      <div className="contenedor">
        <div className="imagen actual">
          <img
            loading="lazy"
            src="http://www.reciclay.com.ve/gio/lake-tahoe.jpg"
          />
        ...
        <div className="imagen">
          <img
            loading="lazy"
            src="http://www.reciclay.com.ve/gio/redwood-national.jpg"
          />
        ...
        <div className="imagen">
          <img
            loading="lazy"
            src="http://www.reciclay.com.ve/gio/yellowstone.jpg"
          />
        ...
        <div className="imagen">
          <img
            loading="lazy"
            src="http://www.reciclay.com.ve/gio/yosemite.jpg"
          />
          <div className="texto">Parque Nacional Yosemite</div>
        </div>

        <a href="#" className="anterior" onclick="anterior()">
          &#10094;
        </a>
        <a href="#" className="siguiente" onclick="siguiente()">
          &#10095;
        </a>
        ...
        <div className="boton">
          <a href="#">
            <img
              loading="lazy"
              src="http://www.reciclay.com.ve/gio/pause.png"
              id="btn"
              onclick="playpause()"
            />
          </a>
