            ...
            doc.setFont("helvetica","bold");
              ...
              doc.text(paquete.precio, 40, 40);

              doc.setFont("helvetica","bold");
              doc.text("ID de Usuario: ", 10, 50);
              doc.setFont("helvetica","normal");
              doc.text(renta.idUser, 40, 50);

              doc.setFont("helvetica","bold");
              doc.text("Nombre: ", 10, 60);
              doc.setFont("helvetica","normal");
              doc.text(data.nombreCompleto, 40, 60);

              doc.setFont("helvetica","bold");
              doc.text("Contacto: ", 10, 70);
              doc.setFont("helvetica","normal");
              doc.text(data.correo, 40, 70);
              doc.text(data.numTel, 40, 75);

              doc.setFont("helvetica","bold");
              doc.text("Fecha de Inicio: ", 10, 80);
              doc.setFont("helvetica","normal");
              doc.text(renta.fechaInicio, 40, 85);

              doc.setFont("helvetica","bold");
              doc.text("Hora de Inicio: ", 10, 90);
              doc.setFont("helvetica","normal");
              doc.text(renta.horaDeInicio, 40, 95);

              doc.setFont("helvetica","bold");
              doc.text("Hora de Finalización: ", 10, 100);
              doc.setFont("helvetica","normal");
              doc.text(renta.horaDeFinalizacion, 40, 105);

              doc.setFont("helvetica","bold");
              doc.text("Fecha de Reserva: ", 10, 110);
              doc.setFont("helvetica","normal");
              doc.text(renta.fechaDeReserva, 40, 115);
              ...
              doc.setFont("helvetica","normal");
              doc.text(renta.observaciones, 40, y+50);
